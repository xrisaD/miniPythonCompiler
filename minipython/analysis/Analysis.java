...
public interface Analysis extends Switch
{
    ...
    void caseAValueSomething(AValueSomething node);
    void caseAIdentifierSomething(AIdentifierSomething node);
    void caseAComparison(AComparison node);
    void caseAOrDisjunction(AOrDisjunction node);
    void caseAAndDisjunction(AAndDisjunction node);
    void caseAAndConjuction(AAndConjuction node);
    void caseANotConjuction(ANotConjuction node);
    void caseANegatedNegated(ANegatedNegated node);
    void caseAClauseNegated(AClauseNegated node);
    void caseAGreatClause(AGreatClause node);
    void caseALessClause(ALessClause node);
    void caseALeqClause(ALeqClause node);
    void caseAGeqClause(AGeqClause node);
    void caseANeqClause(ANeqClause node);
    void caseAEqClause(AEqClause node);
    void caseALiteralClause(ALiteralClause node);
